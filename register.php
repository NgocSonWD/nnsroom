...
<body>
    ...
    <div id="warpper">
        <from id="form-login">
            ...
            <div class="form-group">
                <i class="fas fa-user"></i>
                <input type="text" name="fullname" class="form-input" placeholder="Tên đầy đủ" required>
            </div>
                 ...
                 if($_POST){
                    ...
                    if($username && $password && $repassword && $fullname){
                        ...
                        if($num_row==1){
                            ...
                            $sql_add = "insert into users (username, password,fullname) values('".$username."','".$password."','".$fullname."')";
            ...
            <div class="bottom">
                <p>Bạn Đã có Tài Khoản ? <a href="index.php">Đăng Nhập</a></p>
            </div>
        </from>
    </div>
    </form>
